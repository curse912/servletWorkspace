...
<body>
	<h1>JSTL</h1>
	<p>
		JSP Standard Tag library 의 약자로, JSP 에서 사용되는 커스텀 액션 태그를 의미한다. <br>
	...
	<h3>JSTL 사용방법</h3>
	 ...
	 2) 다운로드 받은 JSPL jar 파일을 WEB-INF/lib에 추가 <br>
	 3) JSPL을 사용하고자 하는 JSP페이지 상단에 taglib 지시어를 사용하여 선언 <br>
	 ...
	 <p>
	 	숫자, 날짜 및 시간데이터의 출력형식을 지정할 때 태그를 제공
	 </p>
