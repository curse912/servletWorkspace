...
<body>
	...
	<form name="menuFrm" action="${pageContext.request.contextPath}/hello/menuOrder.do" method="GET">
		메인메뉴 : 
		<select id="main_menu" name="main_menu" required>	<!-- name 속성이 없으면 값이 넘어가지 않음 -->
